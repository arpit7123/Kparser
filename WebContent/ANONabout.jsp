...
<body>
	<header class="navbar navbar-inverse navbar-static-top" role="banner">
		<div class="container container_new">
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand title" title="XYZ Parser">XYZ
					Parser</a>
			</div>
			<!-- <nav class="collapse navbar-collapse" role="navigation">
				<ul class="nav navbar-nav" id="navigation">
					<li><a href="/kparser/about.jsp"
						title="About Knowledge Parser">About</a></li>
					<li><a href="/kparser/api.jsp"
						title="API for Knowledge Parser">API</a></li>
	...
	<div class="container container_new">
		<div class="row">
					...
					<div class="nav nav-stacked" id="sidebar">
						<h3>
							<a id="getoggler" href="#about" data-toggle="collapse"
								...
								class="label label-default">About XYZ Parser</span></a>
						</h3>
						<h3>
			...
			<div class="col-md-9">
				<div id="about">
					<h1 style="text-align: center">About XYZ Parser</h1>
					<p>XYZ Parser is a semantic parser that translates any English
					...
					<p>The figure below illustrates the basic algorithm of XYZ with
						the help of an example sentence.</p>
					<!-- <img src="/kparser/images/system.png" border="5" -->
					<img
						src="/home/arpit/workspace/Kparser/WebContent/images/system.png"
						border="5" class="imgborder" title="XYZ system algorithm"
						alt="XYZ Example">
				...
				<div id="semRelations">
					<h1 style="text-align: center">Semantic Relations used in XYZ
						Parser</h1>
					<p>
						The semantic relation labels in the output of XYZ are inspired
